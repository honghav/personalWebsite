...
export default function AboutAndWork() {
  return (
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
        <div className="space-y-6">
          ...
          <p className="text-lg text-slate-600 dark:text-slate-400">
            I’m a developer who believes code is a tool for storytelling. Whether it's 
            optimizing a database query or polishing a hover effect, I focus on the details 
            that make users feel seen.
          </p>
        </div>
        
        {/* Quick Stats Card (Simplified) */}
        <div className="p-1 bg-gradient-to-br from-blue-500 to-cyan-400 rounded-3xl">
           <div className="bg-white dark:bg-slate-900 p-8 rounded-[calc(1.5rem-1px)]">
              ...
              <ul className="space-y-3 text-slate-600 dark:text-slate-400">
                <li className="flex items-center gap-2"><ChevronRight size={16} className="text-blue-500"/> Based in Phnom Penh</li>
                <li className="flex items-center gap-2"><ChevronRight size={16} className="text-blue-500"/> Available for freelance</li>
                <li className="flex items-center gap-2"><ChevronRight size={16} className="text-blue-500"/> Love Building Open Source</li>
              </ul>
           </div>
        </div>
      </div>
